...
const experiences = [
  {
    ...
    actions: [
      ...
      "Autonomously managing multiple projects and overseeing budget forecasts, designer and external vendor interactions, and strategic planning to drive departmental success.",
